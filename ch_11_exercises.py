...
class Dwelling:
    ...
    def set_number(self, number_of_rooms):
        self.__number_of_rooms = number_of_rooms
...
def main():
    ...
    home = SingleFamilyHome('6', '1200', '1 f', 'single car', '.25 acres')


# 8) Display the data using the accessor methods
    print('Number of rooms: ', home.get_number_of_rooms(), '\n Square feet: ', home.get_square_feet(),
          '\nFloors: ', home.get_floors()), '\nGarage type: ', home.get_garage_type(),\
        '\nYard size: ', home.get_yard_size()
