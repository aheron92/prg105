...
class SceneFive(Frame):
    def __init__(self, master):
        ...
        text.insert(INSERT, "\n \nHarpooning fish was not as easy as you thought it would be, but after"
                            "\nmany hours of fishing, you and your fellow fisher manage to get enough"
                            "\nfish for the rest of the camp. While away, the others have found a clean"
                            "\nwater source and have managed to build a fire. One of them tells you they"
                            "\nheard some noises in the jungle as they were looking for water.")
