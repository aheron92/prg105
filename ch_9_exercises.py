...
birthdays = {'Meri': 'May 16', 'Kathy': 'July 14', 'Adam': 'July 10', 'Ryne': 'October 11', 'Kara': 'October 05'}
# 2) Print Meri's Birthday
if 'Meri' in birthdays:
    print(birthdays['Meri'])
if 'Meri' not in birthdays:
    print("Meri is not found")
...
miles = miles_ridden.pop('June 4', 'Entry not found.')
print(miles)
print(miles_ridden)
...
if 'Mon' in days:
    ...
    print("'Mon' was not found in the set.")
